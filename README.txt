...
Step 1: First build your program with the "Submission" configuration selected and make sure the folder "Submission" exists. The path to the executable should be: Submission/*.exe
...
Lab9.sln - The Visual Studios solution.
...
CPU_Sort- Contains the Visual Studios project and source code for the CPU sort.
Radix_Sort- Contains the Visual Studios project and source code for the Radix sort.
